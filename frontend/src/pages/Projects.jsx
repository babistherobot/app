              ...
              <Link to={`/project/${project.slug}`} className="block">
                ...
                >
                  ...
                  <div className="relative aspect-video overflow-hidden bg-[#1a1a1a] mb-6">
                    ...
                    {project.featured && (
                      <div className="absolute top-4 right-4 label-small px-3 py-2 bg-[#38FF62] text-[#0a0a0a]">
                        FEATURED
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex flex-col flex-grow">
                    ...
                    <div className="mb-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <p className="label-small mb-3 text-[#38FF62]">TECH STACK</p>
                      <div className="flex flex-wrap gap-2">
                        ...
                        {project.tech.length > 5 && (
                          <span className="label-small px-2 py-1 bg-[#1a1a1a] text-[#38FF62]">
                            +{project.tech.length - 5}
                          </span>
                        )}
                      </div>
                    ...
                    <div className="flex gap-4 pt-4 border-t border-[#2a2a2a]">
                      ...
                      {project.links.demo && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="btn-ghost p-0 flex items-center gap-2 group-hover:text-[#38FF62]"
                          onClick={(e) => e.stopPropagation()}
                        >
